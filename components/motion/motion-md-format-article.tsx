    ...
    <article className="min-w-0">
      ...
      >
        <p className="text-base leading-relaxed text-foreground/85">
          ...
          staggered fade-up. A 300ms ease-out. A scale-on-hover for buttons. A
          generic spring bounce. It works. It also looks like every other
          AI-generated site.
        </p>
        ...
        <ul className="space-y-2 text-base leading-relaxed text-foreground/85">
          <li>
            ...
            (&ldquo;use 0.16, 1, 0.3, 1 for ease-out, 150ms for hover, 400ms
            for entrances, no bounce, tight springs&hellip;&rdquo;) and still
      ...
      <MotionMdFormatSection id="the-fix" title="The fix: MOTION.md">
        <p className="text-base leading-relaxed text-foreground/85">
          ...
          Lottie JSON blob. Picture a document where an experienced motion
          designer explains a brand&rsquo;s animation vocabulary to a developer
          who&rsquo;s writing animations for the first time. That&rsquo;s what
          it reads like.
        </p>
        ...
        <ul className="space-y-2 text-base leading-relaxed text-foreground/85">
          ...
          <li>
            ...
            <code className="text-sm">--duration-instant: 60ms</code> for toggle
            states. <code className="text-sm">--duration-slow: 500ms</code> for
            section entrances. The name tells you how fast it goes; the context
            tells you why.
          </li>
          <li>
        ...
        <p className="text-base leading-relaxed text-foreground/85">
          MOTION.md keeps the rule, the code, and the rationale in the same
          file. A duration token tells you how long. A keyframe tells you what
          it does. The philosophy section is what lets an agent make the right
          call when it hits a situation the file never covers.
        </p>
      </MotionMdFormatSection>
      ...
      <MotionMdFormatSection id="why-markdown" title="Why markdown?">
        <p className="text-base leading-relaxed text-foreground/85">
          ...
          another. They can&rsquo;t open a Framer file. They will imitate a
          motion reference but won&rsquo;t understand the physics model behind
          it. Markdown sits in the middle: readable by humans, parseable by
          machines, easy to version and diff, and you can drop it in a project
          root.
        </p>
      ...
      <MotionMdFormatSection id="why-a-collection" title="Why a collection?">
        <p className="text-base leading-relaxed text-foreground/85">
          ...
          Vercel feel,&rdquo; or &ldquo;make it move like Stripe.&rdquo; These
          references are real. They come up constantly.
        </p>
        ...
        <p className="text-base leading-relaxed text-foreground/85">
          The goal is not &ldquo;copy Figma&rsquo;s animations.&rdquo; It is to
          give the agent a starting language. Enough context to escape the
          generic average and land on a specific motion aesthetic. From there
          you drift, you make it yours, you evolve it.
        </p>
      </MotionMdFormatSection>

      {/* 6. What it's not */}
      <MotionMdFormatSection
        id="what-motion-md-is-not"
        title="What MOTION.md is not"
      >
        <p className="text-base leading-relaxed text-foreground/85">
      ...
      <MotionMdFormatSection id="mental-model" title="Mental model">
        ...
        <p className="text-base leading-relaxed text-foreground/85">
          An AI agent doesn&rsquo;t have that shared context. MOTION.md writes
          it into a file and puts it in the agent&rsquo;s &ldquo;head.&rdquo;
          The reference pool you built with a designer over years, you set up
          with an agent in two minutes.
        </p>
      ...
      <MotionMdFormatSection
        id="structure"
        title="The structure of a MOTION.md file"
      >
        <p className="text-base leading-relaxed text-foreground/85">
          ...
          making a specific animation decision.
        </p>
...
- **Color transitions carry weight** - hover states shift background fill, not opacity.`}
        ...
        <p className="text-base leading-relaxed text-foreground/85">
          Motion reads against a background. The same fade-up animation behaves
          differently on white versus near-black. This block documents the
          canvas color, surface colors, border colors, text colors, and brand
          accent colors so the agent can write animations that feel right
...
\`\`\``}
        ...
        <p className="text-base leading-relaxed text-foreground/85">
          The easing curves are the most important part of a motion system. Two
          brands can use the same duration but feel completely different because
...
polished product motion - smooth deceleration, no overshoot.`}
        ...
        <p className="text-base leading-relaxed text-foreground/85">
          The actual <code className="text-sm">@keyframes</code> blocks. Every
          MOTION.md defines a consistent set of entrance keyframes (fade up,
          fade down, fade in, slide in left/right, scale in) and exit keyframes
          (fade out, slide out). These are the reusable building blocks that
...
\`\`\``}
        ...
        <p className="text-base leading-relaxed text-foreground/85">
          Defines how sections, feature grids, and content blocks enter as the
          user scrolls. Includes the IntersectionObserver threshold, the
          transition configuration, and the stagger delay pattern for
          multi-child reveals.
        </p>

        <MotionMdFormatCodeDisplay
          label="Scroll reveals"
          code={`## Scroll-Triggered Section Reveals
...
\`\`\``}
        ...
        <p className="text-base leading-relaxed text-foreground/85">
          For teams using React animation libraries, every MOTION.md includes a
          Framer Motion section that translates the CSS keyframes and
          transitions into motion variants, spring configs, and AnimatePresence
          wrappers.
        </p>
...
\`\`\``}
      ...
      {/* 9. Quick start */}
      <MotionMdFormatSection id="quick-start" title="Quick start">
        ...
        <p className="mt-6 text-base leading-relaxed text-muted-foreground">
          <em>
            These are not official design systems from the listed companies.
            They are curated starting points inspired by publicly visible
            animation patterns. All trademarks, brand names, and design elements
            belong to their respective owners. These MOTION.md files document
            publicly observable motion patterns for educational and development
            purposes.
          </em>
        </p>
      </MotionMdFormatSection>
